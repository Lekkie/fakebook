      ...
      <div class="w3-row-padding">
        <div class="w3-col m12">
          <div class="w3-card w3-round w3-white">
            ...
            <c:if test="${empty recipientAdded}">

                <form:form method="POST" modelAttribute="recipientForm" class="form-signin">
                    ...
                    <spring:bind path="fullname">
                        <div class="form-group ${error != null ? 'has-error' : ''}">
                            <form:input type="text" path="fullname" class="form-control" placeholder="Recipient Name"  autofocus="true"></form:input>
            ...
            <c:if test="${not empty recipientAdded}">
                <h2 class="form-signin-heading">Recipient added</h2>

                <p><a href="/payment">Pay ${recipientForm.fullname}</a></p>
            </c:if>
