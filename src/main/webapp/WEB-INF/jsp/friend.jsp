      ...
      <div class="w3-row-padding">
        <div class="w3-col m12">
          <div class="w3-card w3-round w3-white">
            ...
            <c:if test="${empty friendAdded}">

                <h2 class="form-signin-heading">Add Recipient</h2>

                <form:form method="POST" modelAttribute="friendForm" class="form-signin">
                    <div class="form-group ${status.error ? 'has-error' : ''}">
                    Select Friend:
                    <select id="friendId" name="friendId" path="friendId"  class="form-control" >
                        <option value="" selected disabled hidden>Choose a Friend</option>
                        <c:forEach items="${requestScope.friendsForm}" var="val">
                            <option value="${val.getFriendId()}"><c:out value="${val.getFullname()}" ></c:out></option>
                        </c:forEach>
                    </select>
                    <form:errors path="friendId"></form:errors>
                    </div>
            ...
            <c:if test="${not empty friendAdded}">
                <h2 class="form-signin-heading">Friend added</h2>

                <p><a href="/payment">Pay ${friendForm.fullname}</a></p>
            </c:if>
