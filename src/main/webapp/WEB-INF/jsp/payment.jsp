      ...
      <div class="w3-row-padding">
        <div class="w3-col m12">
          <div class="w3-card w3-round w3-white">
            ...
            <c:if test="${empty paymentSent}">

            <form:form method="POST" modelAttribute="paymentForm" class="form-signin">
                    <h2 class="form-signin-heading">Pay</h2>

                <div class="form-group ${status.error ? 'has-error' : ''}">
                Select Recipient:
                <select id="recipientId" name="recipientId" path="recipientId" class="form-control" >
                    <option value="" selected disabled hidden>Choose Recipient</option>
                    <c:forEach items="${requestScope.recipientsForm}" var="val">
                        <option value="${val.getRecipientId()}"><c:out value="${val.getFullname()}" ></c:out></option>
                    </c:forEach>
                </select>
                <form:errors path="recipientId"></form:errors>
                </div>

                <div class="form-group ${status.error ? 'has-error' : ''}">
                Select Currency:
                <select id="currencyId" name="currencyId" path="currencyId"  class="form-control" >
                    <option value="" selected disabled hidden>Choose Currency</option>
                    <c:forEach items="${requestScope.currenciesForm}" var="val">
                        <option value="${val.getCurrencyId()}"><c:out value="${val.getCode()}" ></c:out></option>
                    </c:forEach>
                </select>
                <form:errors path="currencyId"></form:errors>
                </div>
            ...
            <c:if test="${not empty paymentSent}">
                <h2 class="form-signin-heading">Payment Sent</h2>
